...
const packages = [
  {
    name: 'Basic',
    price: 2500000,
    description: 'Audit website dasar untuk domain utama',
    features: [
      'Crawl hingga 50 halaman',
      'Performa dasar (LCP, CLS)',
      'SEO dasar (title, description, canonical)',
      'Aksesibilitas dasar (alt text, label)',
      'Keamanan dasar (HTTPS, header minimal)',
      'Laporan PDF ringkas',
    ],
    icon: Zap,
    popular: false,
  },
  {
    name: 'Pro',
    price: 5000000,
    description: 'Paling populer untuk audit website menyeluruh',
    features: [
      'Crawl hingga 200 halaman',
      'Performa detail (LCP, FID, CLS)',
      'SEO menengah (schema, heading structure)',
      'Aksesibilitas menengah (kontras warna, fokus)',
      'Keamanan (CSP, HSTS, mixed content)',
      'Visualisasi data interaktif',
      'Rekomendasi actionable + priority',
      'Priority support',
    ],
    icon: BarChart3,
    popular: true,
  },
  {
    name: 'Enterprise',
    price: 12000000,
    description: 'Audit website skala besar dan multi-subdomain',
    features: [
      'Crawl hingga 1000 halaman + sitemap',
      'Performa lanjutan (profiling, waterfall)',
      'SEO lanjutan (structured data, i18n)',
      'Aksesibilitas lanjutan (WCAG checklist)',
      'Keamanan lanjutan (headers lengkap, best practices)',
      'Action plan detail + timeline',
